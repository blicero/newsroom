// /home/krylon/go/src/github.com/blicero/newsroom/blacklist/00_blacklist_test.go
// -*- mode: go; coding: utf-8; -*-
// Created on 13. 04. 2026 by Benjamin Walkenhorst
// (c) 2026 Benjamin Walkenhorst
// Time-stamp: <2026-04-13 15:02:15 krylon>
...
func TestMain(m *testing.M) {
	var (
		err     error
		result  int
		baseDir = time.Now().Format("/tmp/newsroom_blacklist_test_20060102_150405")
	)
